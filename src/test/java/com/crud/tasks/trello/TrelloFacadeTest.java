...
class TrelloFacadeTest {
    ...
    void shouldCreateCard() {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("test", "test", "top", "test_id");
        TrelloCard mappedTrelloCard = new TrelloCard("test", "test", "top", "test_id");
        Badge badge = new Badge();
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "test", "http://test.com", badge);
        ...
        assertEquals(createdTrelloCardDto.getBadges(), newCard.getBadges());
